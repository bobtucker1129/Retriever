...
Long-form design and policy for **retriever-rebuild** lives here so the **repo root** stays a thin **session spine** (`KICKOFF.md`, `PLAN.md`, `PARKED.md`, `SESSION-LOG.md`, `HANDOVER.md`).

**Navigation:** [`../README.md`](../README.md) maps these files by role (operator, developer, auth, deploy).
